...
// to store no of facilites we are using  use pairs
    ...
    HashMap<String, Hotel> hotelDb = new HashMap<>(); // name vs hotel
    HashMap<Integer, User> userDb = new HashMap<>(); //aadhar vs User
